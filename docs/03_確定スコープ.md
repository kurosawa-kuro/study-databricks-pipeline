...
> **検証済み (2026-05-24)**。mlops-dev-a + Databricks Free Edition に対し、GCS → Cloud Run Job → Volume → COPY INTO → Table の end-to-end が成功(`row_count = 3`、COPY INTO 冪等性も確認)。詳細は [04_検証記録.md](04_検証記録.md)。
